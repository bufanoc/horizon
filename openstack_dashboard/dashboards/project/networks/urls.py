...
urlpatterns = [
    ...
    re_path(NETWORKS % 'create_acl', ovn_views.CreateACLView.as_view(), name='create_acl'),
    re_path(NETWORKS % 'create_lb', ovn_views.CreateLoadBalancerView.as_view(), name='create_lb'),
    re_path(NETWORKS % r'lb/(?P<lb_id>[^/]+)/add_member',
            ovn_views.AddLBMemberView.as_view(), name='add_lb_member'),
